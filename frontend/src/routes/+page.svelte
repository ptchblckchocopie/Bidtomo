...
<svelte:head>
  <title>BidMo.to - The Future of Filipino Online Auctions</title>
  <meta name="description" content="Bid mo 'to! Join our experimental bidding platform and help shape the future of online auctions in the Philippines" />
</svelte:head>

<!-- Remove padding from main wrapper since layout already has it -->
<div class="-mx-4 sm:-mx-6 lg:-mx-8 -my-6 sm:-my-8">
  <!-- Beta Notice Banner -->
  <div class="bg-gradient-to-br from-yellow-400 to-yellow-500 border-b-4 border-yellow-600 px-4 sm:px-6 lg:px-8 py-4">
    <div class="max-w-7xl mx-auto text-center">
      <span class="inline-block bg-black/20 text-white px-3 py-1 rounded-full text-xs font-bold tracking-wider mb-2">
        🚧 EXPERIMENTAL
      </span>
      <p class="text-white text-sm sm:text-base leading-relaxed">
        We're testing what works and gathering public interest.
        <strong class="font-bold underline">No integrated payments yet</strong> - transactions are coordinated directly between buyers and sellers.
