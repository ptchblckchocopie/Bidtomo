...
<div class="max-w-[800px] mx-auto py-4 sm:py-8">
  <h1 class="headline-bh text-2xl sm:text-4xl mb-2 uppercase tracking-tighter">List Your Product</h1>
  ...
  <div class="bg-bh-red text-white border-2 border-bh-border p-4 sm:p-6">
    <h3 class="font-bold text-lg text-white mb-2 uppercase tracking-wide">Before You List</h3>
